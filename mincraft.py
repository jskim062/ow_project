...
while True:
    ...
    #print(xx)
    #print(yy)
    aim = {'left':710, 'top': 290, 'width': 500, 'height': 500}
    ...
    for (lower, upper) in boundaries:
        ...
        #pyautogui.moveTo(710 + cX,290 + cY)
        mouse.move_mouse((710 + cX,290 + cY))


        #pyautogui.moveRel(cX, cY)

        #mouse.move_mouse((xx = cX * 0.001,yy * 0.001))
        #xx = xx + 1
        #yy = yy + 1
        #time.sleep(2.0)
